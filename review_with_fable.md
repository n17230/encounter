...
## 0. Healing now generates threat (new mechanic)
...
## 1. Earthen Bastion (NEEDS AN EDITOR STEP BEFORE IT WORKS AT ALL), Team Up redirect change
...
## 2. Hunter's Bow (first ranged basic attack), Staff now two-handed
...
## 3. Boots of Lightness (new air-hover mechanic), Armored Boots, Amulet of Vitality +5 Armor
...
## 4. Crippling Blow / Seismic Slam weapon-scaled damage, Trample retune, Tomb of the Magi, The Everflow
...
## 5. Global cooldown, Aura spells (replacing the amulets + Echolocator), Cleanse, 2 new amulets
...
## 6. Broad Sword threat, 2H Axe, two-handed/off-hand exclusivity
...
## 7. Seven new warrior spells/item (Reaper's Wheel, Trample, Cleave, Team
...
## 8. Five new healing spells + shields + Holy Scepter — biggest untested batch yet
...
## 9. Player 2 falling through the map on spawn — fix applied, needs confirming
...
## 10. Mana-on-successful-cast, and mob dots always red
...
## 11. Force Compression / Force Expansion / ground-targeted casting (highest risk — newest, most moving parts)
...
## 13. One For All (damage redirect) — genuinely new mechanic, unrun
...
## 15. Party frames + F1–F5 targeting + minimap compass
...
## 17. Gear — ring slots and the recent renumbering
...
## 18. General combat/economy numbers worth a sanity pass
...
## 19. Reported by the user, not yet looked into
...
## 20. Still outstanding from earlier sessions (unrelated to the above, just parked here)
