...
## 0. Soul Siphon (new mechanic: tick lifesteal)
...
## 2. Armorbreaker (new mechanic: stacking effects)
...
## 4. Aegis of the Ancient (block chance), Aegis of Reflection (damage reflect), Shield renamed
...
## 5. Arctic Winds (NEEDS AN EDITOR STEP BEFORE IT WORKS AT ALL)
...
## 6. Healing now generates threat (new mechanic)
...
## 7. Earthen Bastion (NEEDS AN EDITOR STEP BEFORE IT WORKS AT ALL), Team Up redirect change
...
## 8. Hunter's Bow (first ranged basic attack), Staff now two-handed
...
## 9. Boots of Lightness (new air-hover mechanic), Armored Boots, Amulet of Vitality +5 Armor
...
## 10. Crippling Blow / Seismic Slam weapon-scaled damage, Trample retune, Tomb of the Magi, The Everflow
...
## 11. Global cooldown, Aura spells (replacing the amulets + Echolocator), Cleanse, 2 new amulets
...
## 12. Broad Sword threat, 2H Axe, two-handed/off-hand exclusivity
...
## 13. Seven new warrior spells/item (Reaper's Wheel, Trample, Cleave, Team
...
## 14. Five new healing spells + shields + Holy Scepter — biggest untested batch yet
...
## 15. Player 2 falling through the map on spawn — fix applied, needs confirming
...
## 16. Mana-on-successful-cast, and mob dots always red
...
## 17. Force Compression / Force Expansion / ground-targeted casting (highest risk — newest, most moving parts)
...
## 19. One For All (damage redirect) — genuinely new mechanic, unrun
...
## 21. Party frames + F1–F5 targeting + minimap compass
...
## 23. Gear — ring slots and the recent renumbering
...
## 24. General combat/economy numbers worth a sanity pass
...
## 25. Reported by the user, not yet looked into
...
## 26. Still outstanding from earlier sessions (unrelated to the above, just parked here)
