...
## 0. Mana orb mob drops (NEEDS AN EDITOR STEP BEFORE IT WORKS AT ALL)
...
## 1. Soul Siphon (new mechanic: tick lifesteal)
...
## 3. Armorbreaker (new mechanic: stacking effects)
...
## 5. Aegis of the Ancient (block chance), Aegis of Reflection (damage reflect), Shield renamed
...
## 6. Arctic Winds (NEEDS AN EDITOR STEP BEFORE IT WORKS AT ALL)
...
## 7. Healing now generates threat (new mechanic)
...
## 8. Earthen Bastion (NEEDS AN EDITOR STEP BEFORE IT WORKS AT ALL), Team Up redirect change
...
## 9. Hunter's Bow (first ranged basic attack), Staff now two-handed
...
## 10. Boots of Lightness (new air-hover mechanic), Armored Boots, Amulet of Vitality +5 Armor
...
## 11. Crippling Blow / Seismic Slam weapon-scaled damage, Trample retune, Tomb of the Magi, The Everflow
...
## 12. Global cooldown, Aura spells (replacing the amulets + Echolocator), Cleanse, 2 new amulets
...
## 13. Broad Sword threat, 2H Axe, two-handed/off-hand exclusivity
...
## 14. Seven new warrior spells/item (Reaper's Wheel, Trample, Cleave, Team
...
## 15. Five new healing spells + shields + Holy Scepter — biggest untested batch yet
...
## 16. Player 2 falling through the map on spawn — fix applied, needs confirming
...
## 17. Mana-on-successful-cast, and mob dots always red
...
## 18. Force Compression / Force Expansion / ground-targeted casting (highest risk — newest, most moving parts)
...
## 20. One For All (damage redirect) — genuinely new mechanic, unrun
...
## 22. Party frames + F1–F5 targeting + minimap compass
...
## 24. Gear — ring slots and the recent renumbering
...
## 25. General combat/economy numbers worth a sanity pass
...
## 26. Reported by the user, not yet looked into
...
## 27. Still outstanding from earlier sessions (unrelated to the above, just parked here)
