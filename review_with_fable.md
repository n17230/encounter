...
## 0. Earthen Bastion (NEEDS AN EDITOR STEP BEFORE IT WORKS AT ALL), Team Up redirect change
...
## 1. Hunter's Bow (first ranged basic attack), Staff now two-handed
...
## 2. Boots of Lightness (new air-hover mechanic), Armored Boots, Amulet of Vitality +5 Armor
...
## 3. Crippling Blow / Seismic Slam weapon-scaled damage, Trample retune, Tomb of the Magi, The Everflow
...
## 4. Global cooldown, Aura spells (replacing the amulets + Echolocator), Cleanse, 2 new amulets
...
## 5. Broad Sword threat, 2H Axe, two-handed/off-hand exclusivity
...
## 6. Seven new warrior spells/item (Reaper's Wheel, Trample, Cleave, Team
...
## 7. Five new healing spells + shields + Holy Scepter — biggest untested batch yet
...
## 8. Player 2 falling through the map on spawn — fix applied, needs confirming
...
## 9. Mana-on-successful-cast, and mob dots always red
...
## 10. Force Compression / Force Expansion / ground-targeted casting (highest risk — newest, most moving parts)
...
## 12. One For All (damage redirect) — genuinely new mechanic, unrun
...
## 14. Party frames + F1–F5 targeting + minimap compass
...
## 16. Gear — ring slots and the recent renumbering
...
## 17. General combat/economy numbers worth a sanity pass
...
## 18. Reported by the user, not yet looked into
...
## 19. Still outstanding from earlier sessions (unrelated to the above, just parked here)
