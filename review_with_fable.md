...
## 1. Armorbreaker (new mechanic: stacking effects)
...
## 3. Aegis of the Ancient (block chance), Aegis of Reflection (damage reflect), Shield renamed
...
## 4. Arctic Winds (NEEDS AN EDITOR STEP BEFORE IT WORKS AT ALL)
...
## 5. Healing now generates threat (new mechanic)
...
## 6. Earthen Bastion (NEEDS AN EDITOR STEP BEFORE IT WORKS AT ALL), Team Up redirect change
...
## 7. Hunter's Bow (first ranged basic attack), Staff now two-handed
...
## 8. Boots of Lightness (new air-hover mechanic), Armored Boots, Amulet of Vitality +5 Armor
...
## 9. Crippling Blow / Seismic Slam weapon-scaled damage, Trample retune, Tomb of the Magi, The Everflow
...
## 10. Global cooldown, Aura spells (replacing the amulets + Echolocator), Cleanse, 2 new amulets
...
## 11. Broad Sword threat, 2H Axe, two-handed/off-hand exclusivity
...
## 12. Seven new warrior spells/item (Reaper's Wheel, Trample, Cleave, Team
...
## 13. Five new healing spells + shields + Holy Scepter — biggest untested batch yet
...
## 14. Player 2 falling through the map on spawn — fix applied, needs confirming
...
## 15. Mana-on-successful-cast, and mob dots always red
...
## 16. Force Compression / Force Expansion / ground-targeted casting (highest risk — newest, most moving parts)
...
## 18. One For All (damage redirect) — genuinely new mechanic, unrun
...
## 20. Party frames + F1–F5 targeting + minimap compass
...
## 22. Gear — ring slots and the recent renumbering
...
## 23. General combat/economy numbers worth a sanity pass
...
## 24. Reported by the user, not yet looked into
...
## 25. Still outstanding from earlier sessions (unrelated to the above, just parked here)
