...
## 0. Armorbreaker (new mechanic: stacking effects)
...
## 2. Aegis of the Ancient (block chance), Aegis of Reflection (damage reflect), Shield renamed
...
## 3. Arctic Winds (NEEDS AN EDITOR STEP BEFORE IT WORKS AT ALL)
...
## 4. Healing now generates threat (new mechanic)
...
## 5. Earthen Bastion (NEEDS AN EDITOR STEP BEFORE IT WORKS AT ALL), Team Up redirect change
...
## 6. Hunter's Bow (first ranged basic attack), Staff now two-handed
...
## 7. Boots of Lightness (new air-hover mechanic), Armored Boots, Amulet of Vitality +5 Armor
...
## 8. Crippling Blow / Seismic Slam weapon-scaled damage, Trample retune, Tomb of the Magi, The Everflow
...
## 9. Global cooldown, Aura spells (replacing the amulets + Echolocator), Cleanse, 2 new amulets
...
## 10. Broad Sword threat, 2H Axe, two-handed/off-hand exclusivity
...
## 11. Seven new warrior spells/item (Reaper's Wheel, Trample, Cleave, Team
...
## 12. Five new healing spells + shields + Holy Scepter — biggest untested batch yet
...
## 13. Player 2 falling through the map on spawn — fix applied, needs confirming
...
## 14. Mana-on-successful-cast, and mob dots always red
...
## 15. Force Compression / Force Expansion / ground-targeted casting (highest risk — newest, most moving parts)
...
## 17. One For All (damage redirect) — genuinely new mechanic, unrun
...
## 19. Party frames + F1–F5 targeting + minimap compass
...
## 21. Gear — ring slots and the recent renumbering
...
## 22. General combat/economy numbers worth a sanity pass
...
## 23. Reported by the user, not yet looked into
...
## 24. Still outstanding from earlier sessions (unrelated to the above, just parked here)
