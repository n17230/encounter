...
- **Authority split**: *movement is owner-authoritative, combat is
  ...
  - **Ground-targeted abilities + pull** (WoW "Blizzard"-style, added
    ...
    Range 30, Cooldown 15s, CastTime 1.5s, ManaCost 120, and the pull
    speed are placeholder numbers, not something the user specified
    beyond the diameter — flagged for tuning.
